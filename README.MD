...
# 📌 프로젝트 이름 및 소개 🏷️
- **프로젝트명**: BBank 팀
- **프로젝트 개요**: 사용자 맞춤 금융 상품 추천 서비스,
실시간 위치 기반 은행 검색, 챗봇 서비스, 환율 계산기 기능 지원
...
### 🎨 Figma
Figma Link :
https://www.figma.com/design/dDetrQDZK7zapQfm4PAs4r/bank-web-project?node-id=0-1&t=b9xu6cysizeSGOdb-1
