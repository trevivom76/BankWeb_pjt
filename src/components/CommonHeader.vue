      ...
      <nav class="d-flex justify-space-between align-center pa-3">
        ...
        <div v-if="isLogin()">
            <div class="text-center">
                ...
                <!-- 환율계산 태그 -->
                <RouterLink :to="{name:'currencycalculator'}">환율계산</RouterLink> |
                <!-- 주변은행 태그 -->
                <RouterLink :to="{name:'aroundbank'}">주변은행</RouterLink> |
                <!-- 커뮤니티 태그 -->
        ...
        <div v-else>
            <div class="text-center">
                <!-- 금리비교 태그 -->
                <a @click="dialog = true">금리비교</a> |
                <!-- 환율계산 태그 -->
                <a @click="dialog = true">환율계산</a> |
                <!-- 주변은행 태그 -->
                <a @click="dialog = true">주변은행</a> |
                <!-- 커뮤니티 태그 -->
                <a @click="dialog = true">커뮤니티</a>
            </div>
        </div>
