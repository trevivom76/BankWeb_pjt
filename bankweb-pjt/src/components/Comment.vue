<template>
    <div>
      <v-card class="px-13 py-12" width="950px" min-height="530px" rounded="xl">
        ...
        <!-- 댓글 작성 창 -->
        <div>
          <p class="currentuser-nickname">{{ articleStore.articledetail.user.nickname }}</p>
          <div class="d-flex justify-center align-center ga-4">
            <img
              :src="articleStore.articledetail.user.profile_img"
              alt="프로필 이미지"
              class="profile-img"
            />
            <textarea
          ...
          <div class="d-flex justify-end align-center">
            <v-btn
              class="v-btn-create-comment mt-2"
              rounded="lg"
              variant="flat"
              color="#484848"
              width="72px"
  ...
  onMounted(() => {
    ...
    articleStore.getComments(payload);
  });
