    ...
    <div class="login-wrapper">
      ...
      <div class="login-form">
        <div class="form-group">
          ...
          <div class="input-wrapper">
            <input id="username" v-model="username" type="text" :class="{ 'error': !usernameIsOk }"
              placeholder="아이디를 입력해주세요" @keyup.enter="logIn()" />
        ...
        <div class="form-group">
          ...
          <div class="input-wrapper">
            <input id="password" v-model="password" :type="show1 ? 'text' : 'password'"
              :class="{ 'error': !passwordIsOk }" placeholder="비밀번호를 입력해주세요" @keyup.enter="logIn()" />
